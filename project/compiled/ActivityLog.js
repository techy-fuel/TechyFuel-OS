...
(() => {
  ...
  function ActivityRow({
    ...
    }, initials(actorName)), /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1,
        minWidth: 0
      }
    ...
    }, actorName), ' ', actionLabel, ' ', /*#__PURE__*/React.createElement(Badge, {
      tone: tone,
      size: "sm",
      style: {
        display: 'inline-flex',
    ...
    }), entityLabel), item.entity_name && /*#__PURE__*/React.createElement("span", {
      style: {
        fontWeight: 'var(--fw-semibold)',
        color: 'var(--text-strong)'
      }
    }, " \"", item.entity_name, "\""))), /*#__PURE__*/React.createElement("span", {
      style: {
  ...
  function ActivityLog() {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "Recent actions across your workspace")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: 8,
        alignItems: 'center'
      ...
      value: ""
    }, "All activity"), entityTypes.map(t => /*#__PURE__*/React.createElement("option", {
      key: t,
      value: t
    }, ENTITY_LABEL[t], "s"))), /*#__PURE__*/React.createElement("button", {
      onClick: load,
      title: "Refresh",
      style: {
        width: 34,
    ...
    }, "Loading activity…"), !loading && items.length === 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        padding: '48px 24px',
        textAlign: 'center'
      }
    ...
    }, "Actions like creating tasks, projects, or docs will show up here.")), !loading && items.map(item => /*#__PURE__*/React.createElement(ActivityRow, {
      key: item.id,
      item: item
    }))));
  }
