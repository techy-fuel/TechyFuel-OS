...
<script>window.onload=function(){window.print()};<\/script>
  ...
  async function runTeam(fmt) {
    ...
    openPDF('Team Productivity Report', `<table><thead><tr><th>Name</th><th>Role</th><th class="r">Total</th><th class="r">Done</th><th class="r">Open</th><th class="r">Completion</th></tr></thead><tbody>
