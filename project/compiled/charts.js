...
function AreaLine({
  ...
  return /*#__PURE__*/_jsxs("svg", {
    ...
    }), [0.25, 0.5, 0.75, 1].map(g => /*#__PURE__*/_jsx("line", {
      x1: "0",
      x2: width,
      y1: height * g,
      y2: height * g,
    ...
    }), pts.map((p, i) => i === pts.length - 1 ? /*#__PURE__*/_jsx("circle", {
      cx: p[0],
      cy: p[1],
      r: "4",
      fill: color,
...
function Bars({
  ...
  return /*#__PURE__*/_jsxs("svg", {
    ...
    children: [[0.33, 0.66, 1].map(g => /*#__PURE__*/_jsx("line", {
      x1: "0",
      x2: width,
