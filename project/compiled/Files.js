...
(() => {
  ...
  function Files() {
    ...
    }, "810 files · 43.6 GB of 100 GB used")), /*#__PURE__*/React.createElement("button", {
      style: {
        display: 'inline-flex',
        alignItems: 'center',
        gap: 7,
    ...
    }, "Team access · version controlled")), FILES.map((f, i) => /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        display: 'flex',
        alignItems: 'center',
    ...
    }, f.who, " · ", f.when)), /*#__PURE__*/React.createElement(Badge, {
      tone: "neutral",
      size: "sm"
