...
(() => {
  ...
  function Team() {
    ...
    }, "Loading…"), !loading && team.length === 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        padding: '60px 24px',
        textAlign: 'center'
      }
    ...
    }, "Invite your first teammate to get started.")), !loading && team.length > 0 && /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'grid',
